...
const AVOption ff_rtsp_options[] = {
    ...
    { "timeout", "set timeout (in microseconds) of socket I/O operations", OFFSET(stimeout), AV_OPT_TYPE_INT64, {.i64 = 0}, INT_MIN, INT_MAX, DEC },
    COMMON_OPTS(),
...
static const AVOption sdp_options[] = {
    ...
    { "listen_timeout", "set maximum timeout (in seconds) to wait for incoming connections", OFFSET(stimeout), AV_OPT_TYPE_DURATION, {.i64 = READ_PACKET_TIMEOUT_S*1000000}, INT_MIN, INT_MAX, DEC },
